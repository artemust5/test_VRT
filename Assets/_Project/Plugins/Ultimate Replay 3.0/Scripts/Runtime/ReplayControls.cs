...
#pragma warning disable 0649 // Value is never assigned - They are assigned in inspector
            ...
            [Header("Playback Mode")] public GameObject playModeRoot;
            public HighlightButton playMode;

            [Header("Record Mode")] public GameObject recordModeRoot;
            public HighlightButton recordMode;

            [Header("Record Mode - Info")] public Text recordDuration;

            [Header("Playback Mode - Info")] public Text playbackTime;

            [Header("Playback Mode - Play/Pause")] public HighlightButton playPause;

            [Header("Playback Mode - Seek")] public Slider seek;
            public Slider seekVisuals;

            [Header("Playback Mode - Speed")] public GameObject playbackSpeedRoot;
            ...
            [Header("Playback Mode - Direction")] public HighlightButton playbackDirection;

            [Header("Playback Mode - Looped")] public HighlightButton playbackLooped;

            [Header("Playback Mode - Stopped")] public HighlightButton playbackStopped;
#pragma warning restore 0649
        ...
        [Tooltip("Will playback stop on the last frame instead of exiting")]
        public bool stopOnEnd;

        [Header("Options")] [Tooltip("Should recording start as soon as the replay controls have loaded")]
        ...
        public static string uniqCodeForReplayName;
        ...
        protected virtual void Awake()
        {
            ...
            uniqCodeForReplayName = guid.ToString().Substring(0, 3);
            recordFileName = Application.persistentDataPath + "/" + recordFileName + uniqCodeForReplayName;
            ...
            if (controls.recordMode.button != null)
                controls.recordMode.button.onClick.AddListener(ReplayBeginRecording);

            if (controls.playPause.button != null) controls.playPause.button.onClick.AddListener(TogglePlaybackPaused);
            if (controls.playbackSpeed.button != null)
                controls.playbackSpeed.button.onClick.AddListener(TogglePlaybackSpeedMenu);
            if (controls.playbackDirection.button != null)
                controls.playbackDirection.button.onClick.AddListener(TogglePlaybackDirection);
            if (controls.playbackLooped.button != null)
                controls.playbackLooped.button.onClick.AddListener(TogglePlaybackLooped);
            if (controls.playbackStopped.button != null)
                controls.playbackStopped.button.onClick.AddListener(TogglePlaybackStopped);

            if (controls.speedX2.button != null)
                controls.speedX2.button.onClick.AddListener(() => SetPlaybackSpeed(2f));
            if (controls.speedNormal.button != null)
                controls.speedNormal.button.onClick.AddListener(() => SetPlaybackSpeed(1f));
            if (controls.speedX075.button != null)
                controls.speedX075.button.onClick.AddListener(() => SetPlaybackSpeed(0.75f));
            if (controls.speedX050.button != null)
                controls.speedX050.button.onClick.AddListener(() => SetPlaybackSpeed(0.5f));
            if (controls.speedX025.button != null)
                controls.speedX025.button.onClick.AddListener(() => SetPlaybackSpeed(0.25f));
        ...
        protected virtual void Update()
        {
            ...
            if (IsRecording == true)
            {
                ...
                if (controls.recordDuration != null)
                    controls.recordDuration.text = "Recording: " + storage.Duration.ToString("0.00");
            }
            ...
            if (IsReplaying == true)
            {
                ...
                else
                {
                    ...
                    if (controls.seekVisuals != null)
                        controls.seekVisuals.SetValueWithoutNotify(playback.PlaybackTimeNormalized);
                }

                // Update time info
                if (controls.playbackTime != null)
                    controls.playbackTime.text = playback.PlaybackTime.ToString("0.00") + " / " +
                                                 playback.Duration.ToString("0.00");
            }
        }
        ...
        public virtual void ReplayBeginPlayback()
        {
            ...
            if (controls.playbackStopped.highlight != null) controls.playbackStopped.highlight.enabled = false;
        ...
        {
            // Toggle enabled
            if (controls.playbackSpeedRoot != null)
                controls.playbackSpeedRoot.SetActive(!controls.playbackSpeedRoot.activeSelf);

            // Toggle highlight
            if (controls.playbackSpeed.highlight != null)
                controls.playbackSpeed.highlight.enabled = !controls.playbackSpeed.highlight.enabled;
        }
        ...
        public void TogglePlaybackDirection()
        {
            ...
            if (IsReplaying == true)
            {
                if (playback.PlaybackDirection == PlaybackDirection.Forward)
                {
                    ...
                    if (controls.playbackDirection.highlight != null)
                        controls.playbackDirection.highlight.enabled = true;
                }
                else
                {
                    // Set forward
                    ...
                    if (controls.playbackDirection.highlight != null)
                        controls.playbackDirection.highlight.enabled = false;
                }
            }
        }
        ...
        public void TogglePlaybackStopped()
        {
            if (IsReplaying != true) return;

            if (playback.EndBehaviour == PlaybackEndBehaviour.EndPlayback)
            {
                playback.Options.PlaybackEndBehaviour = PlaybackEndBehaviour.StopPlayback;
                if (controls.playbackStopped.highlight != null) controls.playbackStopped.highlight.enabled = true;
            }
            else
            {
                playback.Options.PlaybackEndBehaviour = PlaybackEndBehaviour.EndPlayback;
        ...
        public void SetPlaybackSpeed(float value)
        {
            ...
            {
                case 200:
                    if (controls.speedX2.highlight != null) controls.speedX2.highlight.enabled = true;
                    break;
                case 100:
                    if (controls.speedNormal.highlight != null) controls.speedNormal.highlight.enabled = true;
                    break;
                case 75:
                    if (controls.speedX075.highlight != null) controls.speedX075.highlight.enabled = true;
                    break;
                case 50:
                    if (controls.speedX050.highlight != null) controls.speedX050.highlight.enabled = true;
                    break;
                case 25:
                    if (controls.speedX025.highlight != null) controls.speedX025.highlight.enabled = true;
                    break;
            }
        }
